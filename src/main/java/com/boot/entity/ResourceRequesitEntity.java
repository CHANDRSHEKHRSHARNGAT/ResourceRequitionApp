...
@Entity
@Table(name ="resourceRequesit")
public class ResourceRequesitEntity {
	...
	@Column(nullable = false)
	private Date availabilityDate = new Date((createdOn.getTime() + 30 * 1000 * 60 * 60 * 24));
